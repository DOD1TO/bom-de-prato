...
class BackEndRegister():
    ...
    def registerBackEnd(self):
        ...
        if user == '' or password == '' or email == '':
            ...
            tk.messagebox.showinfo('ERRO', 'A senha inserida tem menos de 5 caracteres. Por Favor insira uma senha maior.')

        elif not '@' in email:
            tk.messagebox.showinfo('ERRO', 'Email invalido.')
...
class LoginBackEnd():
    ...
    def loginBackEnd(self):
        ...
        if user == '' and password == '':
            ...
            if not login:
                tk.messagebox.showinfo('Usuario/Senha incorreto', 'Usuario/Senha incorreto.')
